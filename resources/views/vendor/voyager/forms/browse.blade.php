                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            @can('edit', $data)
                                                <a href="{{ route('voyager.enquiries.index') }}?key=id&filter=contains&s={{ $data->{$data->getKeyName()} }}" title="{{ __('voyager::generic.view') }}" class="btn btn-sm btn-warning pull-right">
                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">View Enquiries</span>
                                                </a>
                                            @endcan
                                        </td>
                                    </tr>
